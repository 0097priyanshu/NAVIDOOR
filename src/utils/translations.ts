...
export const TRANSLATIONS: Record<SupportedLanguageCode, TranslationDictionary> = {
  ...
  hi: {
    ...
    modes: {
      ...
      location: { name: 'स्थान', description: 'लाइव लोकेशन और जीपीएस ट्रैकिंग।' },
      medical: { name: 'चिकित्सा', description: 'मेडिकल और स्वास्थ्य रिकॉर्ड।' },
    },
    sceneDescriptions: {
  ...
  mr: {
    ...
    modes: {
      ...
      location: { name: 'स्थान', description: 'रिअल-टाइम जीपीएस स्थान आणि पत्ता.' },
      medical: { name: 'वैद्यकीय', description: 'वैद्यकीय माहिती आणि आरोग्य कार्ड.' },
    },
    sceneDescriptions: {
  ...
  gu: {
    ...
    modes: {
      ...
      location: { name: 'સ્થળ', description: 'લાઈવ લોકેશન અને જીપીએસ ટ્રેકિંગ.' },
      medical: { name: 'મેડિકલ', description: 'મેડિકલ અને વિગતો.' },
    },
    sceneDescriptions: {
  ...
  pa: {
    ...
    modes: {
      ...
      location: { name: 'ਸਥਾਨ', description: 'ਲਾਈਵ ਲੋਕੇਸ਼ਨ ਟ੍ਰੈਕਿੰਗ।' },
      medical: { name: 'ਮੈਡੀਕਲ', description: 'ਮੈਡੀਕਲ ਜਾਣਕਾਰੀ।' },
    },
    sceneDescriptions: {
  ...
  bn: {
    ...
    modes: {
      ...
      location: { name: 'স্থান', description: 'লাইভ অবস্থান ট্র্যাকিং।' },
      medical: { name: 'মেডিকেল', description: 'মেডিকেল তথ্য।' },
    },
    sceneDescriptions: {
  ...
  ta: {
    ...
    modes: {
      ...
      location: { name: 'இடம்', description: 'நேரலை இருப்பிட கண்காணிப்பு.' },
      medical: { name: 'மருத்துவ', description: 'மருத்துவ விவரங்கள்.' },
    },
    sceneDescriptions: {
  ...
  te: {
    ...
    modes: {
      ...
      location: { name: 'స్థానం', description: 'లైవ్ లొకేషన్ ట్రాకింగ్.' },
      medical: { name: 'మెడికల్', description: 'మెడికల్ వివరాలు.' },
    },
    sceneDescriptions: {
  ...
  kn: {
    ...
    modes: {
      ...
      history: { name: 'ಇತಿಹಾಸ', description: '3 ಇತ್ತೀਚಿನ ಬರಹಗಳನ್ನು ಉಳಿಸಲಾಗಿದೆ.' },
      settings: { name: 'ಸೇಟಿಂಗ್ಸ್', description: 'ಸಿಸ್ಟಮ್ ಸೇಟಿಂಗ್ಸ್ ಮತ್ತು ಆಯ್ಕೆಗಳು.' },
      languages: { name: 'ಭಾಷೆಗಳು', description: 'ಸಕ್ರಿಯ ಭಾಷೆ: ಕನ್ನಡ.' },
      location: { name: 'ಸ್ಥಳ', description: 'ಲೈವ್ ಸ್ಥಳದ ಮಾಹಿತಿ.' },
      medical: { name: 'ವೈದ್ಯಕೀಯ', description: 'ವೈದ್ಯಕೀಯ ವಿವರಗಳು.' },
    },
    sceneDescriptions: {
  ...
  ml: {
    ...
    modes: {
      ...
      location: { name: 'സ്ഥലം', description: 'തത്സമയ ലൊക്കേഷൻ വിവരങ്ങൾ.' },
      medical: { name: 'മെഡിക്കൽ', description: 'മെഡിക്കൽ വിവരങ്ങൾ.' },
    },
    sceneDescriptions: {
